  ...
  return (
    <div className="w-74 bg-white border rounded-lg flex flex-col items-left px-6 py-4 border-gray-200 m-6 shadow-md gap-6">
      ...
      <div className="flex w-full gap-1">
        <button className="flex-1  bg-blue text-white text-xs font-medium rounded-lg px-4 py-1.5 hover:bg-blue/95 hover:shadow-lg hover:shadow-blue/50 cursor-pointer transition transform duration-300 hover:-translate-y-0.5 flex justify-center items-center gap-1">
          <Copy size="md" />
          Copy Link
        </button>
        <button className="bg-red-200 text-red-600 px-2 py-1 rounded-lg hover:shadow-lg hover:shadow-red-400/20 cursor-pointer transition transform duration-300 hover:-translate-y-0.5">
          <Trash size="md" />
        </button>
      </div>
    </div>
